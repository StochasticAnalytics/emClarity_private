...
class AssetTypeToolbar(QWidget):
    ...
    def setup_ui(self):
        ...
        for asset_id, label, icon in asset_types:
            ...
            button.clicked.connect(lambda checked, aid=asset_id: self.select_asset_type(aid))
...
class AssetDataTable(QWidget):
    ...
    def setup_ui(self):
        ...
        columns = [
            "I.D.", "Tilt-Series Name", "Parent I.D.", "Align I.D.", 
            "X Size", "Y Size", "Pixel Size", "Cs", "Voltage", 
            "Tilt Range", "Status"
        ]
        ...
        header.setSectionResizeMode(1, QHeaderView.Stretch)  # Name column (main content)
    ...
    def populate_sample_data(self):
        ...
        sample_data = [
            ["1", "TS_001_tilt_series", "-1", "-1", "4096", "4096", "0.6431", "2.70", "300.00", "±60°", "Valid"],
            ["2", "TS_002_tilt_series", "-1", "-1", "4096", "4096", "0.6431", "2.70", "300.00", "±65°", "Valid"],
            ["3", "TS_003_tilt_series", "-1", "-1", "4096", "4096", "0.6431", "2.70", "300.00", "±55°", "Processing"],
            ["4", "TS_004_tilt_series", "-1", "-1", "4096", "4096", "0.6431", "2.70", "300.00", "±60°", "Failed"],
            ["5", "TS_005_tilt_series", "-1", "-1", "4096", "4096", "0.6431", "2.70", "300.00", "±70°", "Valid"],
            ["6", "TS_006_tilt_series", "-1", "-1", "4096", "4096", "0.6431", "2.70", "300.00", "±58°", "Valid"],
            ["7", "TS_007_tilt_series", "-1", "-1", "4096", "4096", "0.6431", "2.70", "300.00", "±62°", "Processing"],
        ]
...
class ActionButtonsPanel(QWidget):
    ...
    def setup_ui(self):
        ...
        buttons = [
            ...
            ("Validate", self.on_validate_clicked)  # Changed from Statistics to Validate
        ]
