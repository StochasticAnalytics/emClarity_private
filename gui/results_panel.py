...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QLabel, QListWidget, QRadioButton,
    QPushButton, QSplitter, QFrame, QButtonGroup, QLineEdit, QScrollArea,
...
class NavigationControls(QWidget):
    ...
    def setup_ui(self):
        ...
        # Connect signals
        self.prev_button.clicked.connect(lambda: self.navigation_clicked.emit("previous"))
        self.delete_button.clicked.connect(lambda: self.navigation_clicked.emit("delete"))
