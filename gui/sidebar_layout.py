...
class VerticalIconButton(QPushButton):
    ...
    def setup_layout(self, text: str, icon: str):
        ...
        icon_label.setStyleSheet("font-size: 60px; margin: 0px;")  # Much larger icon to fill toolbar width
        ...
        text_label.setStyleSheet("font-size: 11px; font-weight: normal; margin: 0px;")  # Larger text
...
class OverviewPanel(QWidget):
    ...
    def setup_header(self, layout):
        ...
        welcome_label = QLabel("Welcome to emClarity (Computational Imaging System for Transmission Electron Microscopy)")
        welcome_font = QFont()
        welcome_font.setPointSize(14)  # Increased from 12
        welcome_label.setFont(welcome_font)
        welcome_label.setAlignment(Qt.AlignCenter)
        welcome_label.setWordWrap(True)
        welcome_label.setStyleSheet("color: #333333; margin: 15px 20px;")  # Increased margins
        header_layout.addWidget(welcome_label)
        
        # Information link - increased font size
        info_link = QLabel('<a href="https://emclarity.org" style="color: #4A90E2; text-decoration: none;">For more information, manuals and tutorials please visit emclarity.org</a>')
        ...
        for label in [self.version_label, self.commit_label, self.branch_label, self.build_label]:
            label.setAlignment(Qt.AlignCenter)
            label.setStyleSheet("color: #666666; font-size: 12px; margin: 2px;")  # Increased from 10px
    ...
    def setup_begin_section(self, layout):
        ...
        begin_label.setStyleSheet("color: #333333; margin-top: 20px; margin-bottom: 15px;")  # Increased margins
        ...
        self.new_project_link = QLabel('<a href="#new" style="color: #4A90E2; text-decoration: none;">Create a new project</a>')
        self.new_project_link.setAlignment(Qt.AlignCenter)
        self.new_project_link.linkActivated.connect(lambda: self.project_requested.emit("new"))
        ...
        self.open_project_link = QLabel('<a href="#open" style="color: #4A90E2; text-decoration: none;">Open an existing project</a>')
        self.open_project_link.setAlignment(Qt.AlignCenter)
        self.open_project_link.linkActivated.connect(lambda: self.project_requested.emit("open"))
    ...
    def setup_recent_projects_section(self, layout):
        ...
        recent_label.setStyleSheet("color: #333333; margin-top: 30px; margin-bottom: 15px;")  # Increased margins
        ...
        browse_link = QLabel('<a href="#browse" style="color: #4A90E2; text-decoration: none;">Browse for project...</a>')
    ...
    def refresh_recent_projects(self):
        ...
        for i in range(self.recent_projects_layout.count()):
            ...
            if item and item.widget():
                ...
                if not (hasattr(widget, 'text') and 'Browse for project' in widget.text()):
        ...
        if not recent_projects:
            ...
            no_recent_label.setStyleSheet("color: #888888; font-style: italic; padding: 12px; font-size: 13px;")  # Increased font size
            ...
            for project in recent_projects:
                ...
                project_link = QLabel(f'<a href="{project_path}" style="color: #4A90E2; text-decoration: none;">{project_path}</a>')
                project_link.setAlignment(Qt.AlignCenter)
                project_link.setWordWrap(False)  # Disable wrapping to keep on one line
                project_link.linkActivated.connect(lambda path=project_path: self.open_recent_project(path))
    ...
    def set_version_info(self, version_info: str, commit_info: str = "", branch_info: str = "", build_info: str = ""):
...
class SidebarNavigationWidget(QWidget):
    ...
    def setup_sidebar(self, layout):
        ...
        sidebar_frame.setFixedWidth(120)  # Increased from 100px to accommodate larger buttons
    ...
    def setup_panels(self, layout):
        ...
        try:
            ...
            try:
                ...
                assets_layout.addWidget(QLabel("This will contain the Assets management interface"))
