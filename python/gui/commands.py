...
class EmClarityCommands:
    ...
    def _define_commands(self) -> Dict[str, EmClarityCommand]:
        ...
        commands['init'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "tomoCpr_iter", "type": "int", "description": "TomoCPR iteration (optional)", "required": False}
            ],
        ...
        commands['segment'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "operation", "type": "choice", "choices": ["build", "recon"], 
                 "description": "build: make bin10 tomos, recon: convert model files", "required": True}
            ],
        ...
        commands['autoAlign'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "stack_name", "type": "file", "description": "Stack file (.st)", "required": True},
                {"name": "tilt_file", "type": "file", "description": "Tilt file (.rawtlt)", "required": True},
                {"name": "tilt_axis", "type": "float", "description": "Tilt axis rotation (degrees)", "required": True},
                {"name": "rotation", "type": "float", "description": "Image rotation (degrees)", "required": True}
            ],
        ...
        commands['alignRaw'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "cycle", "type": "int", "description": "Cycle number", "required": True},
                {"name": "experimental_option", "type": "choice", "choices": ["1", "2", "3"], 
                 "description": "1: abs(ccc), 2: weighted, 3: abs(weighted)", "required": False}
            ],
        ...
        commands['ctf'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "operation", "type": "choice", "choices": ["estimate", "refine", "update", "3d"],
                 "description": "CTF operation to perform", "required": True},
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "tilt_base", "type": "string", "description": "Tilt base name", "required": False},
                {"name": "scratch_disk", "type": "string", "description": "Local scratch disk path", "required": False}
            ],
        ...
        commands['templateSearch'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "tomo_name", "type": "string", "description": "Tomogram name", "required": True},
                {"name": "tomo_idx", "type": "int", "description": "Tomogram index", "required": True},
                {"name": "template", "type": "file", "description": "Template file", "required": True},
                {"name": "symmetry", "type": "string", "description": "Symmetry (e.g., C1)", "required": True},
                {"name": "threshold", "type": "float", "description": "Threshold override (optional)", "required": False},
                {"name": "gpu_idx", "type": "int", "description": "GPU index", "required": True}
            ],
        ...
        commands['cleanTemplateSearch'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "pixel_size", "type": "float", "description": "Pixel size (Angstroms)", "required": True},
                {"name": "distance", "type": "float", "description": "Distance to neighbor (Angstroms)", "required": True},
                {"name": "angle", "type": "float", "description": "Angular deviation (degrees)", "required": True},
                {"name": "neighbors", "type": "int", "description": "Minimum number of neighbors", "required": True}
            ],
        ...
        commands['removeNeighbors'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "pixel_size", "type": "float", "description": "Pixel size (Angstroms)", "required": True},
                {"name": "cycle", "type": "string", "description": "Cycle identifier", "required": True},
                {"name": "distance", "type": "float", "description": "Distance cutoff (Angstroms)", "required": True},
                {"name": "angle", "type": "float", "description": "Angle cutoff (degrees)", "required": True},
                {"name": "neighbors", "type": "int", "description": "Number of neighbors", "required": True}
            ],
        ...
        commands['avg'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "cycle", "type": "int", "description": "Cycle number", "required": True},
                {"name": "stage", "type": "choice", "choices": ["raw", "cluster_cls"],
                 "description": "Stage of alignment", "required": True}
            ],
        ...
        commands['calcWeights'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "cycle", "type": "int", "description": "Cycle number", "required": True},
                {"name": "prefix", "type": "string", "description": "Output prefix", "required": True},
                {"name": "symmetry", "type": "string", "description": "Symmetry (e.g., C1)", "required": True},
                {"name": "gpu_idx", "type": "int", "description": "GPU index (optional)", "required": False}
            ],
        ...
        commands['mask'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "input_file", "type": "file", "description": "Input file (.mrc) or output for geometric mask", "required": True},
                {"name": "output_file", "type": "string", "description": "Output file (.mrc)", "required": False},
                {"name": "pixel_size", "type": "float", "description": "Pixel size (Angstroms)", "required": True},
                {"name": "shape", "type": "choice", "choices": ["sphere", "cylinder", "rectangle"],
                 "description": "Shape for geometric mask", "required": False},
                {"name": "size", "type": "string", "description": "Size [nX,nY,nZ] for geometric mask", "required": False},
                {"name": "center", "type": "string", "description": "Center [cX,cY,cZ] for geometric mask", "required": False}
            ],
        ...
        commands['pca'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "cycle", "type": "int", "description": "Cycle number", "required": True},
                {"name": "random_subset", "type": "bool", "description": "Use random subset", "required": True},
                {"name": "focused_mask", "type": "choice", "choices": ["0", "1", "2", "3"],
                 "description": "0: none, 1: std dev, 2: variance, 3: user supplied", "required": False}
            ],
        ...
        commands['skip'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "iteration", "type": "int", "description": "Iteration number", "required": True}
            ],
        ...
        commands['reconstruct'] = EmClarityCommand(
            ...
            parameters=[
                ...
                {"name": "prefix", "type": "string", "description": "Output prefix", "required": True},
                {"name": "symmetry", "type": "string", "description": "Symmetry (e.g., C1)", "required": True},
                {"name": "max_exposure", "type": "float", "description": "Max exposure (e/A^2)", "required": True},
                {"name": "class_idx", "type": "int", "description": "Class index (-1 for all)", "required": False, "default": -1}
            ],
        ...
        commands['tomoCPR'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "cycle", "type": "int", "description": "Cycle number", "required": True},
                {"name": "stage", "type": "choice", "choices": ["Avg", "RawAlignment", "Cluster_cls"],
                 "description": "Stage of alignment", "required": True},
                {"name": "tilt_start", "type": "int", "description": "Starting tilt number (optional)", "required": False}
            ],
        ...
        commands['rescale'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "input_file", "type": "file", "description": "Input file", "required": True},
                {"name": "output_file", "type": "string", "description": "Output file", "required": True},
                {"name": "pixel_in", "type": "float", "description": "Input pixel size (Angstroms)", "required": True},
                {"name": "pixel_out", "type": "float", "description": "Output pixel size (Angstroms)", "required": True},
                {"name": "device", "type": "choice", "choices": ["cpu", "GPU"], "description": "Processing device", "required": True}
            ],
        ...
        commands['benchmark'] = EmClarityCommand(
            ...
            parameters=[
                ...
                {"name": "scratch_disk", "type": "string", "description": "Fast scratch disk path", "required": True},
                {"name": "workers", "type": "int", "description": "Number of workers", "required": True}
            ],
        ...
        commands['geometry'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "cycle", "type": "int", "description": "Cycle number", "required": True},
                {"name": "stage", "type": "string", "description": "Stage of alignment", "required": True},
                {"name": "operation", "type": "choice", 
                 "choices": ["SwitchCurrentCycle", "UpdateTilts", "WriteCsv", "RemoveClasses", 
                           "ShiftAll", "ShiftBin", "ListTomos", "RemoveTomos",
                           "ListPercentiles", "RemoveFraction", "RemoveIgnoredParticles", "RandomizeEulers"],
                 "description": "Geometry operation", "required": True},
                {"name": "vect_op", "type": "string", "description": "Vector operation [0,0,0]", "required": True},
                {"name": "halfset", "type": "choice", "choices": ["STD", "EVE", "ODD"], 
                 "description": "Half-set selection", "required": True}
            ],
        ...
        commands['combineProjects'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "projects", "type": "string", "description": "Space-separated list of project files", "required": True}
            ],
        ...
        commands['montage'] = EmClarityCommand(
            ...
            parameters=[
                {"name": "param_file", "type": "file", "description": "Parameter file (.m)", "required": True},
                {"name": "cycle", "type": "int", "description": "Cycle number", "required": True},
                {"name": "stage", "type": "choice", "choices": ["RawAlignment", "Cluster_cls"],
                 "description": "Stage of alignment", "required": True},
                {"name": "class_num", "type": "int", "description": "Class number", "required": True},
                {"name": "operation", "type": "string", "description": "unstack or angles [ZXZ]", "required": True},
                {"name": "halfset", "type": "choice", "choices": ["odd", "eve", "std"],
                 "description": "Half-set selection", "required": True}
            ],
