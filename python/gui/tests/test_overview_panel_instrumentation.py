...
def test_overview_panel_instrumentation():
    ...
    test_clicks = [
        {
            ...
            "additional_data": {
                "link_target": "new",
                "link_text": "Create a new project",
            },
        },
        {
            ...
            "additional_data": {
                "link_target": "open",
                "link_text": "Open an existing project",
            },
        },
        {
    ...
    for i, click_data in enumerate(test_clicks, 1):
        ...
        if captured_data and captured_data["element_id"] == click_data["element_id"]:
            ...
            print(
                f"   📝 Data: {captured_data['element_type']} in {captured_data['panel_context']} panel"
            )
        else:
