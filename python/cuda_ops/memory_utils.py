...
def ensure_f(x: cp.ndarray, *, allow_copy: bool = False, dtype: cp.dtype | None = None) -> cp.ndarray:
    """
...
def ensure_c(x: cp.ndarray, *, allow_copy: bool = False, dtype: cp.dtype | None = None) -> cp.ndarray:
    """
