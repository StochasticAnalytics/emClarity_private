...
switch varargin{1}
  ...
  case 'skip'
    if emcProgramHelp || ...
      ...
      fprintf(['\nUsage: emClarity skip param.m iter [optional: AssignAndMergeToBranch|RemoveClasses|Override]\n']);
    else
      emC_testParse(varargin{2});
  ...
  case 'geometry'
    if emcProgramHelp || ...
      ...
      fprintf(['\nUsage: emClarity geometry param.m cycle stage operation vectOP halfset [keepMod]\n\n',...
        ...
        '  keepMod   - (RemoveClasses only, optional) 2nd .mod = curated KEEP selection;\n',...
        '              emits cycleNNN_ClassKeep_<half>.txt alongside the normal ClassMods output\n\n',...
        'Operations:\n',...
        '  Metadata Operations:\n',...
        '    SwitchCurrentTomoCpr, UpdateTilts, WriteCsv, TrimOldCycles\n',...
        '  Particle Operations:\n',...
  ...
  case 'templateSearch'
    if emcProgramHelp || ...
      ...
      fprintf(['\nUsage: emClarity templateSearch param.m tomo_name tomo_idx template_name symmetry gpu_idx [threshold]\n\n',...
        ...
        '  mapBackIter   - [Deprecated] Accepted but ignored, warns if given\n\n',...
        'Output: Creates convolution maps in ./convmap/ directory\n\n',...
        'Examples:\n',...
        '  emClarity templateSearch param.m tomo01 1 ref.mrc C1 0\n',...
        '  emClarity templateSearch param.m tomo01 1 ref.mrc C4 0\n']);
    else
      wedgeType = 2;
